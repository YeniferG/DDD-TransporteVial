...
public class AgregarAliado extends Command {
    ...
    public AgregarAliado(ServicioId servicioId, AliadoId aliadoId, TipoDocumento tipoDocumento, TipoPersona tipoPersona, Nombre nombre, Email email, Direccion direccion, Telefono telefono, Vehiculo datosVehiculo) {
